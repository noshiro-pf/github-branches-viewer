...
const ReadmeSectionBody = memo(({ repository, onRefresh }: Props) => {
    ...
    const initStarryNight = async () => {
      try {
        ...
        const [
          ...
          import(/* webpackChunkName: "starry-night-js" */ '@wooorm/starry-night/source.js'),
          import(/* webpackChunkName: "starry-night-ts" */ '@wooorm/starry-night/source.ts'),
          import(/* webpackChunkName: "starry-night-python" */ '@wooorm/starry-night/source.python'),
          import(/* webpackChunkName: "starry-night-java" */ '@wooorm/starry-night/source.java'),
          import(/* webpackChunkName: "starry-night-css" */ '@wooorm/starry-night/source.css'),
          import(/* webpackChunkName: "starry-night-html" */ '@wooorm/starry-night/text.html.basic'),
          import(/* webpackChunkName: "starry-night-json" */ '@wooorm/starry-night/source.json'),
          import(/* webpackChunkName: "starry-night-md" */ '@wooorm/starry-night/text.md'),
          import(/* webpackChunkName: "starry-night-shell" */ '@wooorm/starry-night/source.shell'),
          import(/* webpackChunkName: "starry-night-yaml" */ '@wooorm/starry-night/source.yaml'),
        ]);
  ...
  if (loading) {
    return <div className={"readme-loading"}>{"Loading README information..."}</div>;
  }

  if (error) {
    return (
      <div className={"readme-error"}>{"Error loading README info: "}{error}</div>
    );
  }
